...
public class FR {
	...
	public static String SV_DESC = "Vous n'avez pas de pouvoir particulier. Votre but est de gagner avec le village, pour cela, vous devez éliminer les joueurs du camp des loups, et les solitaires.";
	...
	public static String ASSASSIN_DESC = "Votre but est de gagner seul, donc être le dernier joueur en vie. Pour cela, vous disposez de livres Power III, Sharpness III et Protection III.";
